...
const LogoWithAssets = ({ size = 50, className = '' }) => {
  ...
  const logoSizes = {
    small: '/assets/images/android-launchericon-48-48.png',
    medium: '/assets/images/android-launchericon-72-72.png', 
    large: '/assets/images/android-launchericon-144-144.png',
    xl: '/assets/images/android-launchericon-192-192.png',
    xxl: '/assets/images/android-launchericon-512-512.png'
  };
