        ...
        <div className="container">
          ...
          <div className="grid grid-3">
            <div className="card hover-card">
              <div style={{ fontSize: '3rem', marginBottom: 'var(--space-md)', color: 'var(--primary-cyan)' }}>AI</div>
            ...
            <div className="card hover-card">
              <div style={{ fontSize: '3rem', marginBottom: 'var(--space-md)', color: 'var(--accent-violet)' }}>◉</div>
            ...
            <div className="card hover-card">
              <div style={{ fontSize: '3rem', marginBottom: 'var(--space-md)', color: 'var(--accent-amber)' }}>📱</div>
